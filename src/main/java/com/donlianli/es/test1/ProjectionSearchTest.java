...
public class ProjectionSearchTest {
	...
	public static void main(String[] args) {
		...
		QueryStringQueryBuilder fqb = QueryBuilders.queryString("married:true");
        ...
        .addField("age")
        //设置过滤条件
        .setPostFilter(FilterBuilders.rangeFilter("weight").from(131834924088936899l).to(2469485369926853902l))   // Filter
        //设置分页信息
